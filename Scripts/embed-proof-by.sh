...
do
	...
	printf "Tagging: %s\n" "${file}"
	eyeD3 -2 \
		--user-text-frame "Local usage note":"This file was downloaded under a Creative Commons CC-BY license and is being used accordingly. Screenshot archived and embedded as proof." \
